# HelloWorld!
This is the unity repo, frontend, for a complete project for my Ada Developer Academy Cohort 24 Capstone Project.\
...
## How to play
The game is currently deployed on itch.io.\
The game is available at this [link](https://wyldgryd.itch.io/helloworld)\
See description of the game on the deployed site for further instructions.

## Tech Stack
Engine: Unity\
Language: C#\
Backend: Flask + Postgres [(see link)](https://github.com/maychanlee/HelloWorld-flask) 

## Assets Resources
All sprite, tilemap and assets were designed by me using Adobe Illustrator.\
Music was recorded through [Audacity](https://www.audacityteam.org/)\
Instrumentals were produced using [OneMotion's chord player](https://www.onemotion.com/chord-player/) with the chord progression written by me. 
